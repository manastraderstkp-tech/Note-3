    ...
    <div className="flex h-full flex-col justify-between p-4 overflow-y-auto">
      <div className="space-y-5">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-slate-50/70 p-3 text-xs dark:border-slate-800 dark:bg-slate-850/50 space-y-2">
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-lg bg-white p-2 text-left font-semibold text-slate-700 shadow-2xs hover:bg-indigo-50 hover:text-indigo-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-750"
          >
        ...
        {/* Supabase & RLS Quick Tools Card */}
        <div className="rounded-2xl border border-slate-200/80 bg-slate-50/70 p-3 text-xs dark:border-slate-800 dark:bg-slate-850/50">
          <div className="flex items-center justify-between">
      ...
      <div className="border-t border-slate-200/80 pt-3 dark:border-slate-800">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-xs font-medium text-slate-500 transition hover:bg-slate-100 hover:text-slate-800 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200"
          title="Reset back to initial sample items"
        >
